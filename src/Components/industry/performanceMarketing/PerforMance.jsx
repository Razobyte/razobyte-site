...
import banner from '../../../../public/Image/perfomence-markting-banner.png'
    ...
    return (
        <>
            ...
            <ScrollTrigger onEnter={() => setClients(true)} onExit={() => setClients(false)} >
                ...
                <Row className='flex justify-center items-center md:py-6 py-2'>
                    <Col md={10} className='flex  flex-col justify-center items-center'>
                        <h2 className='sm:text-5xl  text-2xl mt-sm-4 mt-2 mb-sm-3 mb-2 font-semibold text-[#5E5E5E] '>Why Razobyte</h2>
                        {/* <h5 className='text-base text-[#3b7fbf]'>Razobyte Unlocking Potential Through Performance Marketing</h5> */}
                        <p className='para text-center'>With 8+ years of experience, Razobyte delivers trusted IT and digital solutions, including website development, digital marketing, and mobile app 
                        services. We focus on helping businesses grow through innovative and effective strategies.</p>
                    </Col>
                </Row>
                <CommonSection title="Looking for Something Else" services={otherServices} bgName="bg-[#EAF2FF]" />
                <Row className='d-md-flex d-none justify-center items-center py-12 w-screen overflow-hidden'>
      <Col md={10} xs={10}>
        {/* Title */}
...
\
    ...
    <TestimonialsSection/>
      ...
      {/* WhatsApp Chat Now Button with Link */}
      ...
      {/* Another WhatsApp Chat Now Button with Link */}
