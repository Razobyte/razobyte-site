import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-ZST6LTSK.js";
import {
  Col_default,
  useCol
} from "./chunk-BGBC6G7P.js";
import {
  Image_default,
  propTypes
} from "./chunk-N4H2ILFC.js";
import {
...
} from "./chunk-6XDM5KIK.js";
import {
  require_prop_types
} from "./chunk-L4SV7HIO.js";
import {
  Row_default
} from "./chunk-G7EH6RWG.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useTimeout() {
  ...
  const handleRef = (0, import_react12.useRef)();
...
var Carousel = React27.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react13.useRef)(null);
  const [direction, setDirection] = (0, import_react13.useState)("next");
  const [paused, setPaused] = (0, import_react13.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react13.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react13.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react13.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react13.useRef)();
  ...
  const handleEnter = (0, import_react13.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react13.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react13.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null ? void 0 : onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react13.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react13.useRef)(0);
  const touchDeltaXRef = (0, import_react13.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react13.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react13.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react13.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react13.useRef)();
  (0, import_react13.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react13.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react14.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react14.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react14.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react15.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react16.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react17.useRef)(modifiers);
  const popperInstanceRef = (0, import_react17.useRef)();
  const update = (0, import_react17.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react17.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react17.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react17.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react17.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react18.useRef)(false);
  const waitingForTrigger = (0, import_react18.useRef)(false);
  const handleMouseCapture = (0, import_react18.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react19.useContext)(DropdownContext_default);
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react20.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react20.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react20.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react20.useState)(true);
  ...
  return (0, import_react20.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react20.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react20.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react20.default).createElement((0, import_react20.default).Fragment, null, props.children);
  }
  return (0, import_react20.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react20.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react20.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react20.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react20.default).useId();
  let [didSSR] = (0, import_react20.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react20.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react20.default)["useSyncExternalStore"] === "function")
    return (0, import_react20.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react20.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react21.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react21.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
function useDropdownItem({
  ...
  const navContext = (0, import_react22.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
var FormLabel = React58.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime55.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var Switch = React62.forwardRef((props, ref) => (0, import_jsx_runtime59.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Offcanvas = React82.forwardRef(({
  ...
  const renderBackdrop = (0, import_react45.useCallback)((backdropProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react52.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ToastFade = React111.forwardRef((props, ref) => (0, import_jsx_runtime116.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React115.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime120.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
